...
class ResourceNotFoundCodeChanged(Rule):
    ...
    def check(self, project: Project) -> list[Finding]:
        ...
        # search_wire pass is correct for Python, TypeScript, and
        # JavaScript alike -- see r001/r006 for rules where the languages
        # genuinely need different patterns, which this one doesn't.
        out: list[Finding] = []
